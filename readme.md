# Personal go lang tools / utils / commands
...
- *t2s* :- recursively converts tabs to spaces for all the files in the directory.
  *ffn* :- recursively corrects function names and its calls across the code base to traditional came case convention. (eg: "another_func" -> "anotherFunc" & "Exported_func" -> "ExportedFunc")
